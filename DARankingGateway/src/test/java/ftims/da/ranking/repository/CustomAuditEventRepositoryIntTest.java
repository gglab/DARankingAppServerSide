...
import ftims.da.ranking.config.audit.AuditEventConverter;
import ftims.da.ranking.domain.PersistentAuditEvent;
...
import static ftims.da.ranking.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
