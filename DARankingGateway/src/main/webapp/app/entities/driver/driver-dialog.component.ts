...
import { DriverAward, DriverAwardService } from '../driver-award';
...
export class DriverDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.driverAwardService.query()
            .subscribe((res: HttpResponse<DriverAward[]>) => { this.driverawards = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackDriverAwardById(index: number, item: DriverAward) {
        return item.id;
    }
